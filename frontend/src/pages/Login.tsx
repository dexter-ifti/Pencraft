...
import { SigninSchema } from '@ifti_taha/common';
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50 relative overflow-hidden">
            ...
            <div className="absolute inset-0 overflow-hidden">
                ...
                <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-gradient-to-r from-blue-400 to-indigo-400 rounded-full opacity-20 animate-float-delayed"></div>
                <div className="absolute top-1/2 left-1/4 w-32 h-32 bg-gradient-to-r from-green-400 to-blue-400 rounded-full opacity-10 animate-pulse"></div>
                <div className="absolute top-1/4 right-1/4 w-24 h-24 bg-gradient-to-r from-yellow-400 to-orange-400 rounded-full opacity-10 animate-bounce"></div>
            </div>
            ...
            <div className="relative z-10 flex flex-col justify-center py-12 sm:px-6 lg:px-8 min-h-screen">
                ...
                <div className={`sm:mx-auto sm:w-full sm:max-w-md mt-4 transition-all duration-1000 delay-200 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                    <div className="text-center">
                        <span className="text-gray-600">New to Pencraft? </span>
                ...
                {/* Footer */}
                <div className={`mt-8 text-center transition-all duration-1000 delay-600 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
